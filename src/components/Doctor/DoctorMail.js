...
const DoctorMail = (props) => {
    ...
    const handelSubmit = e => {
        e.preventDefault();
        setLoading(true);
        const data = { time: time.getTime(), receiver, subject: emailData.subject, body: emailData.body, meetingTime: time.toLocaleString() }
        axios.post('/api/records/schedule', data, {
            headers: {
        ...
        <div className="container">
            <div className='row'>
                <div className='col s12 m8 l8 offset-l2 offset-m2'>
                    <div id=''>
                        <form onSubmit={handelSubmit} className='padding-form shadow' noValidate>
                            ...
                            <div className='row'>
                                <div className='input-field'>
                                    <textarea name="body" value={emailData.body} onChange={handleInputChange} id="body" className="materialize-textarea">
                                    </textarea>
                                    <label htmlFor="body" className='active font-app'>Email body</label>
                                </div>
                            </div>
                            <div className='row'>
                                {!loading && (
