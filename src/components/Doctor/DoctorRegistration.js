...
function DoctorRegistration(props) {
    ...
    const register = async (e) => {
        ...
        if (name === '') {
            ...
            M.toast({ html: 'Please enter about your speciality, minimum 5 characters' });
        } else if (!file) {
            M.toast({ html: 'Please pick an image' })
        } else if (!isValid) {
            M.toast({ html: 'Please pick one of the file format image: ".jpg,.png,.jpeg"' })
        } else {
            setLoading(true);
                    ...
                    <div className='col s12 m5 l5'>
                        <div id='slide'>
                            <form onSubmit={register} className='padding-form'>
                                ...
                                <div className='row'>
                                    <div className='input-field'>
                                        <textarea value={speciality} onChange={handleSpeciality} id="speciality" className="materialize-textarea" data-length="120"></textarea>
                                    ...
                                    <div className="input-field">
                                        ...
                                        <div className={`image-upload`}>
                                            <div className="image-upload__preview">
                                                {previewUrl && <img width="100" height="100" src={previewUrl} alt="Preview" />}
                                                {/* {!previewUrl && <p>Please pick an image.</p>} */}
                                            </div>
                                            <button type="button" onClick={pickImageHandler} className='btn btn-large pcolour btn-register waves-effect waves-light hover'>
