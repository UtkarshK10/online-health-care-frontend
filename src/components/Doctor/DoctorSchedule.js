...
import CurrentPatientDetails from './PatientDetailsCard';
...
const DoctorSchedule = () => {
  ...
  if (isDetails) {
    ...
    return <CurrentPatientDetails currPatient={currPatient} />;
  }
  return (
        ...
        {patientDetails.map((patientDetail, idx) => (
          <li className='row' key={idx}>
            ...
            <div className='col s12 m3 l3 offset-m3 offset-l3'>
              <button className='btn btn-medium pcolour btn-register waves-effect waves-light hover'>
                Send Mail
